?do_3band@EQ_VCLASS_TYPEDEF@@YA?AV?$vector4@MT__m128@@@VCLASS_TYPEDEF@@PAUEQSTATE@1@AAV23@@Z PROC ; EQ_VCLASS_TYPEDEF::do_3band, COMDAT
	...
	ret	0
?do_3band@EQ_VCLASS_TYPEDEF@@YA?AV?$vector4@MT__m128@@@VCLASS_TYPEDEF@@PAUEQSTATE@1@AAV23@@Z ENDP ; EQ_VCLASS_TYPEDEF::do_3band
