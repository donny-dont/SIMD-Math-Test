?Verlet@Cloth@CLOTH_VCLASS_TYPEDEF@@QAEXXZ PROC		; CLOTH_VCLASS_TYPEDEF::Cloth::Verlet, COMDAT
; _this$ = ecx
	movaps	xmm2, XMMWORD PTR __xmm@0
	movaps	xmm3, XMMWORD PTR __xmm@1
	xor	edx, edx
	cmp	DWORD PTR [ecx+490212], edx
	jle	SHORT $LN1@Verlet@2
	mov	eax, ecx
	npad	6
$LL3@Verlet@2:
	...
	jl	SHORT $LL3@Verlet@2
$LN1@Verlet@2:
	ret	0
?Verlet@Cloth@CLOTH_VCLASS_TYPEDEF@@QAEXXZ ENDP		; CLOTH_VCLASS_TYPEDEF::Cloth::Verlet
