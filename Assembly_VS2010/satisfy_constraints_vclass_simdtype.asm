?SatisfyConstraints@Cloth@CLOTH_VCLASS_SIMDTYPE@@QAEXXZ PROC ; CLOTH_VCLASS_SIMDTYPE::Cloth::SatisfyConstraints, COMDAT
; _this$ = ecx
	sub	esp, 8
	cmp	DWORD PTR [ecx+490208], 0
	movaps	xmm4, XMMWORD PTR __xmm@2
	mov	DWORD PTR _j$114798[esp+8], 0
	jle	$LN7@SatisfyCon@3
	push	ebx
	push	esi
	push	edi
$LL129@SatisfyCon@3:
	...
	dec	eax
	mov	DWORD PTR _i$114802[esp+20], 0
	test	eax, eax
	jle	$LN8@SatisfyCon@3
	mov	edx, ecx
...
$LL3@SatisfyCon@3:
	...
	jl	SHORT $LL3@SatisfyCon@3
$LN5@SatisfyCon@3:
	mov	eax, DWORD PTR _i$114802[esp+20]
	mov	esi, DWORD PTR [ecx+490212]
	inc	eax
	dec	esi
	add	edx, 16					; 00000010H
	add	ebx, 68					; 00000044H
	mov	DWORD PTR _i$114802[esp+20], eax
	cmp	eax, esi
	jl	$LL128@SatisfyCon@3
$LN8@SatisfyCon@3:
	mov	eax, DWORD PTR _j$114798[esp+20]
	inc	eax
	mov	DWORD PTR _j$114798[esp+20], eax
	cmp	eax, DWORD PTR [ecx+490208]
	jl	$LL129@SatisfyCon@3
	pop	edi
	pop	esi
	pop	ebx
$LN7@SatisfyCon@3:
	add	esp, 8
	ret	0
?SatisfyConstraints@Cloth@CLOTH_VCLASS_SIMDTYPE@@QAEXXZ ENDP ; CLOTH_VCLASS_SIMDTYPE::Cloth::SatisfyConstraints
