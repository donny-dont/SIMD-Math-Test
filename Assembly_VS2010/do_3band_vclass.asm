?do_3band@EQ_VCLASS@@YA?AVVec4@VCLASS@@PAUEQSTATE@1@AAV23@@Z PROC ; EQ_VCLASS::do_3band, COMDAT
	...
	ret	0
?do_3band@EQ_VCLASS@@YA?AVVec4@VCLASS@@PAUEQSTATE@1@AAV23@@Z ENDP ; EQ_VCLASS::do_3band
