?VSin@VCLASS@@YA?AVVec4@1@ABV21@@Z PROC			; VCLASS::VSin, COMDAT
	push	ebp
	mov	ebp, esp
	...
	mulps	xmm3, xmm0
	mulps	xmm5, xmm0
	movaps	XMMWORD PTR tv642[esp+16], xmm0
	mulps	xmm2, xmm0
	mulps	xmm4, xmm0
	mulps	xmm6, xmm0
	mulps	xmm1, xmm0
	...
	mulps	xmm5, xmm0
	mulps	xmm7, xmm0
	mulps	xmm7, XMMWORD PTR tv642[esp+16]
	mulps	xmm7, XMMWORD PTR tv642[esp+16]
	addps	xmm7, XMMWORD PTR tv642[esp+16]
	mulps	xmm2, xmm0
	mulps	xmm4, xmm0
	mulps	xmm6, xmm0
	mulps	xmm1, xmm0
	...
	pop	ebp
	ret	0
?VSin@VCLASS@@YA?AVVec4@1@ABV21@@Z ENDP			; VCLASS::VSin
